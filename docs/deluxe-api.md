...
are in [the product specification](deluxe-specification.md).

The first playable build implements [development protocol 0.1](deluxe-protocol-0.1.md),
...
```json
{"kind":"request","id":"r1","method":"hello","params":{"protocols":[{"major":1,"minor":0}],"client":{"id":"org.angband.deluxe","version":"0.1.0"},"max_frame_bytes":1048576}}
```

Backend response (capabilities abbreviated):

```json
{"kind":"response","id":"r1","result":{"protocol":{"major":1,"minor":0},"engine":{"id":"org.angband.angband","version":"4.2.6-deluxe-dev","build":"example-build","save_compatibility":"angband-example"},"capabilities":{"state.player":1,"state.map":1,"state.items":1,"commands":1,"prompts":1,"terminal.fallback":1},"max_frame_bytes":1048576}}
```
