...
int main(int argc,char **argv) {
 try {
  ...
  AnybandUITheme::current.invert_dungeon=true;
  check(AnybandUITheme::dungeon_colour(IM_COL32(12,15,20,180))==IM_COL32(243,240,235,180),"Dungeon inversion preserves alpha");
  AnybandUITheme::current=ThemeSettings{};
  ...
  FontLibrary font_library; font_library.load(ANYBANDUI_FONTS_DIR);
