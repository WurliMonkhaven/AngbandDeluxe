...
static void anybandui_store_request(const char *id, const char *method, cJSON *params)
{
 cJSON *record;
 ...
 if (purchase ? !pile_contains(active_store->stock,obj) : !anybandui_store_can_sell(obj)) {
