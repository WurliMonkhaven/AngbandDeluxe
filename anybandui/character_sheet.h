...
struct CharacterSheet {
 ...
 static void attributes(const json &sheet) {
  AnybandUITheme::section("Attributes");
 ...
 static void contents(const json &sheet,const json &items=json::array(),const json &slots=json::array(),const std::string &name="") {
  if(ImGui::BeginTabBar("Character pages")) {
   ...
   if(ImGui::BeginTabItem("Resistances & abilities")) {
    ImGui::BeginChild("Defences scroll"); AnybandUITheme::section("Resistances");
    ...
    AnybandUITheme::section("Abilities & sustains");
   ...
   if(ImGui::BeginTabItem("Background")) {
    ImGui::BeginChild("Background scroll"); AnybandUITheme::section("History");
