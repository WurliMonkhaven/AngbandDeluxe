...
static AnybandUIGpuUploadStats anybandui_upload_stats;
AnybandUIGpuUploadStats AnybandUIGpuGetUploadStats() { return anybandui_upload_stats; }
]=])
gpu_replace([=[    // FIXME-OPT: Not optimal, but this is fairly rarely called.
    ...
    ++anybandui_upload_stats.buffer_growths;]=])
gpu_replace("    uint32_t vertex_size = draw_data->TotalVtxCount * sizeof(ImDrawVert);" [=[    ++anybandui_upload_stats.uploads;
...
{
    AnybandUIGpuRenderRange(draw_data, command_buffer, render_pass, 0, draw_data->CmdListsCount, pipeline);
}

void AnybandUIGpuRenderRange(ImDrawData* draw_data, SDL_GPUCommandBuffer* command_buffer, SDL_GPURenderPass* render_pass, int first, int last, SDL_GPUGraphicsPipeline* pipeline)]=])
gpu_replace([=[    int global_idx_offset = 0;
    ...
    for (const ImDrawList* draw_list : draw_data->CmdLists)
    {
        ...
        for (int cmd_i]=])
set(gpu_backend_file "${CMAKE_CURRENT_BINARY_DIR}/imgui_impl_sdlgpu3_anybandui.cpp")
