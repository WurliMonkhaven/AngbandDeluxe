...
struct GameTuning {
 ...
 void scalar(const json &e) {
  ...
  if(changed) ImGui::PushStyleColor(ImGuiCol_Text,AnybandUITheme::green());
 ...
 void draw() {
  ...
  ImGui::Spacing(); ImGui::TextColored(AnybandUITheme::green(),"%d custom settings",modified_count());
